...
import { createPost, deletePost, getAllCategories, getAllPost, getAllPostsByAuthor, getAllPublishedPosts, getPostsByCategory, getPostsById, togglePostStatus, updatePostById } from '../controllers/blogController';
...
postRoutes.post('/create',verifyToken,validateZod(blogSchema),createPost);
...
postRoutes.get('/author/:id',getAllPostsByAuthor);
